...
//        Création du formulaire des préférences
        ...
        return $this->container->get('templating')->renderResponse(
                        'FOSUserBundle:ChangePassword:changePassword.html.' . $this->container->getParameter('fos_user.template.engine'), array('form_pref'=> $form_pref->createView(),'form_password' => $form_password->createView())
        );
    }
